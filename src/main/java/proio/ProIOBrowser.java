 ...
 * <h1>ProIO Browser</h1>
 *
 * <p>This program creates an event viewer and file browser. It allows a user to select a file and
 * display the number of events to choose. Then the user is able to go to an event and gather the
 * tags from that event. when a user selects a tag it populates a table. In the table if the user
 * selects an entry they can then view its entry data.
 *
 * <p>
 */
package proio;
...
public class ProIOBrowser extends javax.swing.JFrame {
  ...
  private void initComponents() {
    ...
    EntryTable.setModel(
        new javax.swing.table.DefaultTableModel(
            new Object[][] {}, new String[] {"ID", "Message Type"}) {
    ...
    eventnumbersearchfield.setFormatterFactory(
        new javax.swing.text.DefaultFormatterFactory(
            new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#0"))));
    eventnumbersearchfield.setToolTipText("Event number");
    eventnumbersearchfield.addKeyListener(
    ...
    HeaderRecord_button.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    Logfile_button.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      java.util.logging.Logger.getLogger(ProIOBrowser.class.getName())
    ...
    java.awt.EventQueue.invokeLater(
        new Runnable() {
          @Override
          public void run() {
            new ProIOBrowser().setVisible(true);
          }
        });
  }
